...
var zhStrings = map[string]string{
	...
	"key_entry_hint":           "    有效期使用 RFC3339，例如 2026-03-31T23:59:59Z；Token Limit 留空表示不限",
	"key_form_nav_hint":        "    Tab/Shift+Tab 或 ↑↓ 切换字段",
	"key_field_required":       "API Key 不能为空",
	"key_field_expiry_invalid": "有效期格式无效，请使用 RFC3339 时间格式",
	"key_field_token_invalid":  "Token Limit 必须是大于等于 0 的整数",
...
var enStrings = map[string]string{
	...
	"key_entry_hint":           "    Use RFC3339 for expiry, e.g. 2026-03-31T23:59:59Z; leave Token Limit empty for unlimited",
	"key_form_nav_hint":        "    Use Tab/Shift+Tab or Up/Down to switch fields",
	"key_field_required":       "API key is required",
	"key_field_expiry_invalid": "Expiry must use RFC3339 format",
	"key_field_token_invalid":  "Token Limit must be an integer >= 0",
